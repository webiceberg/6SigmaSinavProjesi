...
public partial class myresult : System.Web.UI.Page
{
    ...
    public void getmyresults(string email)
    {
        using (SqlConnection con = new SqlConnection(s))
        {
                ...
                using(SqlDataAdapter ad = new SqlDataAdapter())
                {
                    ...
                    using (DataTable tb = new DataTable())
                    {
                        ...
                        else
                        {
                            ...
                            lbl_myresultshowwarning.Text = "Üzgünüm! Herhangi bir sınav sonucu bulunamadı";
                        }
                    }
                }
            ...
            {
                panel_myresultshow_warning.Visible = true;
                lbl_myresultshowwarning.Text = "Bir şeyler yanlış gitti. Daha sonra tekrar deneyiniz</br> Ya da geliştirici ile iletişime geçiniz" + ex.Message;
            }
        }
    }
