                ...
                <div class="col-lg-3 mb-3">
                    <div class="card h-100 text-center">
                        ...
                        <div class="card-footer">
                            <asp:HyperLink ID="btn_category" runat="server" CssClass="btn btn-primary" ForeColor="White" NavigateUrl='<%# "~/categoryitem.aspx?cid=" +  Eval("category_id") %>'>Sınavlara Git</asp:HyperLink>
                        </div>
                    </div>
                </div>
            </ItemTemplate>
