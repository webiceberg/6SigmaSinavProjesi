        ...
        using (SqlConnection con = new SqlConnection(s))
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    lbl_questshowwarning.Text = "Üzgünüm! Bu sınavda herhangi bir soru yok";
                }
            }
            catch (Exception ex)
            {
                panel_questshow_warning.Visible = true;
                lbl_questshowwarning.Text = "Bir şeyler yanlış gitti. Daha sonra tekrar deneyiniz</br> Ya da geliştirici ile iletişime geçiniz" + ex.Message;
            }
        }
    }
            ...
            try
            {
                ...
                while (rd.Read())
                {
                    if (select_number == Convert.ToInt32(rd["question_answer"]))
                    {
                        ...
                        correct_number = correct_number + (100 / gridview_examquestion.Rows.Count);
                        break;
                    }
                    else
                    {
