            ...
            <ItemTemplate>
                <div class="col-lg-4 mb-4">
                    <div class="card h-100">
                        <h3 class="card-header">Sınav Adı: <%# Eval("exam_name") %></h3>
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item">Sınav Açıklaması: <%# Eval("exam_description") %></li>
                            <li class="list-group-item">Geçme Notu: <%# Eval("exampass_marks") %></li>
                            <li class="list-group-item">Total Puan: <%# Eval("exam_marks") %></li>
                            <li class="list-group-item">
                                <asp:HyperLink ID="hlink_gotexam" runat="server" CssClass="btn btn-primary" ForeColor="White" NavigateUrl='<%# "~/question.aspx?eid=" + Eval("exam_id")%>'>Sınava Gir</asp:HyperLink>
                            </li>
                        </ul>
                    </div>
                </div>
