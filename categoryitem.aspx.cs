        ...
        using (SqlConnection con = new SqlConnection(s))
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    lbl_subjectshowwarning.Text = "Üzgünüm! Bu derste bir sınav yok";
                }
            }
            catch (Exception ex)
            {
                panel_subjectshow_warning.Visible = true;
                lbl_subjectshowwarning.Text = "Bir şeyler yanlış gitti. Lütfen daha sonra tekrar deneyiniz</br> Ya da Geliştirici ile iletişime geçin" + ex.Message;
            }
        }
    }
