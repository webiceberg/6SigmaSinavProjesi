    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="btn-group bg-danger">
                <asp:Button ID="btn_panelcategorylist" runat="server" Text="Ders Listesi" CssClass="btn btn-info" OnClick="btn_panelcategorylist_Click" BorderStyle="None" CausesValidation="False" />
                <asp:Button ID="btn_paneladdcategory" runat="server" Text="Ders Ekle" CssClass="btn btn-info" OnClick="btn_paneladdcategory_Click" BorderStyle="None" CausesValidation="False" />
            </div>
            <%--Add category panel--%>
            <asp:Panel ID="panel_addcategory" runat="server">
                <div class="card-body">
                    <div class="row form-group">
                        <label class="col-md-2 col-form-label">Ders Adı</label>
                        <div class="col-md-4">
                            <asp:TextBox ID="txt_category" runat="server" CssClass="form-control"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="require_category" runat="server" ErrorMessage="Bir Ders Adı Giriniz" ControlToValidate="txt_category" ForeColor="red"></asp:RequiredFieldValidator>
                        </div>
                    </div>
                    <div class="card-footer">
                        <div class="offset-2">
                            <asp:Button ID="btn_addcategory" runat="server" Text="Ekle" CssClass="btn" BackColor="#343A40" BorderStyle="None" ForeColor="White" OnClick="btn_addcategory_Click" />
                        </div>
