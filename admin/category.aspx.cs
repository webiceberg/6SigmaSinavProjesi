...
public partial class admin_category : System.Web.UI.Page
{
    ...
    protected void btn_addcategory_Click(object sender, EventArgs e)
    {
            ...
            using (SqlConnection con = new SqlConnection(s))
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        lbl_categoryaddwarning.Text= "Bir şeyler yanlış gitti.";
                    }
                }
                catch(Exception ex)
                {
                    txt_category.Focus();
                    panel_addcategory_warning.Visible = true;
                    lbl_categoryaddwarning.Text = "Bir şeyler yanlış gitti." + ex.Message;
                }
        ...
        else
        {
            txt_category.Focus();
            panel_addcategory_warning.Visible = true;
            lbl_categoryaddwarning.Text = "Tüm alanları doldurmalısınız";
        }
    ...
    public void categorylistmethod()
    {
        using(SqlConnection con = new SqlConnection(s)){
            ...
            catch(Exception ex)
            {
                ...
                lbl_categorylistwarning.Text = "Bir şeyler yanlış gitti." + ex.Message;
            }
        }
    }
    ...
    public void deletecategory(int id)
    {
        using (SqlConnection con = new SqlConnection(s))
        {
            ...
            try
            {
                ...
                {
                    panel_categorylist_warning.Visible = true;
                    lbl_categorylistwarning.Text = "Bir şeyler yanlış gitti.";
                }
            }
            catch (Exception ex)
            {
