    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="btn-group bg-danger">
                <asp:Button ID="btn_panelresult" runat="server" Text="Tüm Öğrenciler" CssClass="btn btn-info" BorderStyle="None" CausesValidation="False" BackColor="#343A40" />
            </div>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <asp:GridView ID="gridallstudents" runat="server" GridLines="None" AllowPaging="True" AutoGenerateColumns="False" CssClass="table table-bordered" PageSize="8" OnPageIndexChanging="gridallstudents_PageIndexChanging">
                            <Columns>
                                <asp:BoundField DataField="user_fname" HeaderText="İsim" />
                                <asp:BoundField DataField="user_lname" HeaderText="Soyisim" />
                                ...
                                <asp:TemplateField HeaderText="Sonuçlar">
                                    <ItemTemplate>
                                        <asp:HyperLink ID="btn_viewquestion" runat="server" CssClass="btn" BackColor="#343A40" BorderStyle="None" ForeColor="White" NavigateUrl='<%# "~/admin/result.aspx?uid=" + Eval("user_email") %>'>
                                            <i class="fa fa-info-circle" aria-hidden="true"></i> Sonuçları Gör
                                        </asp:HyperLink>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
