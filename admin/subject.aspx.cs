...
public partial class admin_subject : System.Web.UI.Page
{
    ...
    protected void btn_addsubject_Click(object sender, EventArgs e)
    {
            ...
            using (SqlConnection con = new SqlConnection(s))
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        lbl_addsubject_warning.Text = "Bir hata oluştu, daha sonra tekrar deneyiniz";
                    }
                }
                catch (Exception ex)
                {
                    txt_subject.Focus();
                    panel_addsubject_warning.Visible = true;
                    lbl_addsubject_warning.Text = "Bir hata oluştu." + ex.Message;
                }
            } //end of using
        }
        else
        {
            txt_subject.Focus();
            panel_addsubject_warning.Visible = true;
            lbl_addsubject_warning.Text = "Gerekli tüm alanları doldurmalısınız";
        }
    ...
    public void getSubjectList()
    {
        using (SqlConnection con = new SqlConnection(s))
        {
            ...
            catch (Exception ex)
            {
                ...
                lbl_subjectlistwarning.Text = "Bir hata oluştu" + ex.Message;
            }
        }
    }
    ...
    public void deletesubject(int id)
    {
        using (SqlConnection con = new SqlConnection(s))
        {
            ...
            try
            {
                ...
                {
                    panel_subjectlist_warning.Visible = true;
                    lbl_subjectlistwarning.Text = "Bir hata oluştu";
                }
            }
            catch (Exception ex)
            {
