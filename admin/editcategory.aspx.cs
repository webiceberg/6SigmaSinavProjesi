...
public partial class admin_editcategory : System.Web.UI.Page
{
    ...
    protected void btn_editcategory_Click(object sender, EventArgs e)
    {
            ...
            using (SqlConnection con = new SqlConnection(cs))
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        lbl_categoryeditwarning.Text = " Bir şeyler yanlış gitti. ";
                    }
                }
                catch (Exception ex)
                {
                    txt_categoryedit.Focus();
                    panel_editcategory_warning.Visible = true;
                    lbl_categoryeditwarning.Text = "Bir şeyler yanlış gitti." + ex.Message;
                }
            } // end of using 
        }
        else
        {
            txt_categoryedit.Focus();
            panel_editcategory_warning.Visible = true;
            lbl_categoryeditwarning.Text = "Tüm Gerekli Alanları Doldurunuz";
        }
