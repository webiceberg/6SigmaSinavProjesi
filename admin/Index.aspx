    ...
    <div class="col-xl-4 col-sm-6 mb-4">
        <div class="card text-white bg-primary o-hidden h-100">
            <div class="card-body">
                ...
                <div class="mr-5">Toplamda <asp:Label ID="lbltotalexam" runat="server"></asp:Label> sınav bulunuyor</div>
            </div>
    ...
    <div class="col-xl-4 col-sm-6 mb-4">
        <div class="card text-white bg-warning o-hidden h-100">
            <div class="card-body">
                ...
                <div class="mr-5">Toplamda <asp:Label ID="lbltotalquestion" runat="server"></asp:Label> soru bulunuyor</div>
            </div>
    ...
    <div class="col-xl-4 col-sm-6 mb-4">
        <div class="card text-white bg-primary o-hidden h-100">
            <div class="card-body">
                ...
                <div class="mr-5">Toplamda <asp:Label ID="lbltotalstudents" runat="server"></asp:Label> öğrenci bulunuyor</div>
            </div>
