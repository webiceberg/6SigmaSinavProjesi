...
public partial class editexam : System.Web.UI.Page
{
    ...
    protected void btn_editexam_Click(object sender, EventArgs e)
    {
            ...
            using (SqlConnection con = new SqlConnection(cs))
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        lbl_exameditwarning.Text = " Bir şeyler yanlış gitti. ";
                    }
                }
                catch (Exception ex)
                {
                    txt_editexamname.Focus();
                    panel_editexam_warning.Visible = true;
                    lbl_exameditwarning.Text = "Bir şeyler yanlış gitti. " + ex.Message;
                }
            } // end of using 
        }
        else
        {
            txt_editexamname.Focus();
            panel_editexam_warning.Visible = true;
            lbl_exameditwarning.Text = "Tüm gerekli alanları doldurmalısınız. ";
        }
