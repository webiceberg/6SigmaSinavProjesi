...
public partial class admin_exam : System.Web.UI.Page
{
    ...
    protected void btn_addexam_Click(object sender, EventArgs e)
    {
            ...
            using (SqlConnection con = new SqlConnection(s))
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        lbl_examaddwarning.Text = "Henüz bir ünite eklenmemiş";
                    }
                }
                catch (Exception ex)
                {
                    txt_examname.Focus();
                    panel_addexam_warning.Visible = true;
                    lbl_examaddwarning.Text = "Bir şeyler yanlış gitti." + ex.Message;
                }
            } //end of using
        }
        else
        {
            txt_examname.Focus();
            panel_addexam_warning.Visible = true;
            lbl_examaddwarning.Text = "Tüm gerekli alanları doldurmalısınız";
        }
    ...
    public void get_subjectdrp()
    {
        using (SqlConnection con = new SqlConnection(s))
        {
            ...
            try
            {
                ...
                ListItem li = new ListItem("Ünite Seçiniz", "-1");
    ...
    public void getexamList()
    {
        using (SqlConnection con = new SqlConnection(s))
        {
            ...
            catch (Exception ex)
            {
                ...
                lbl_examlistwarning.Text = "Bir şeyler yanlış gitti." + ex.Message;
            }
        }
    }
    ...
    public void deleteexam(int id)
    {
        using (SqlConnection con = new SqlConnection(s))
        {
            ...
            try
            {
                ...
                {
                    panel_examlist_warning.Visible = true;
                    lbl_examlistwarning.Text = "Bir şeyler yanlış gitti.";
                }
            }
            catch (Exception ex)
            {
