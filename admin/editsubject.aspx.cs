...
public partial class admin_editsubject : System.Web.UI.Page
{
    ...
    protected void btn_editsubject_Click(object sender, EventArgs e)
    {
            ...
            using(SqlConnection con = new SqlConnection(s))
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        lbl_editsubject_warning.Text = "Bir şeyler yanlış gitti. ";
                    }
                }
                catch (Exception ex)
                {
                    txt_subjectedit.Focus();
                    panel_editsubject_warning.Visible = true;
                    lbl_editsubject_warning.Text = "Bir şeyler yanlış gitti." + ex.Message;
                }
            } // end of using
        }
        else
        {
            txt_subjectedit.Focus();
            panel_editsubject_warning.Visible = true;
            lbl_editsubject_warning.Text = "Tüm gerekli alanları doldurmalısınız";
        }
    }
