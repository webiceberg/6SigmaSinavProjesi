        ...
        using (SqlConnection con = new SqlConnection(s))
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    lbl_examshowwarning.Text = "Üzgünüm! Bu kategoride bir sınav yok";
                }
            }
            catch (Exception ex)
            {
                panel_examshow_warning.Visible = true;
                lbl_examshowwarning.Text = "Bir şeyler yanlış gitti. Daha sonra tekrar deneyiniz</br> Ya da geliştirici ile iletişime geçiniz" + ex.Message;
            }
        }
    }
