...
<asp:Content ID="Content2" ContentPlaceHolderID="maincontentplaceholder" runat="Server">
        <h2 class="m-4">
            Tüm <asp:Label ID="lbl_categorysubject" runat="server"></asp:Label> Sınavları</h2>
        <hr />
    <div class="row">
                ...
                <div class="col-lg-3 mb-3">
                    <div class="card h-100 text-center">
                        ...
                        <div class="card-footer">
                            <asp:HyperLink ID="btn_category" runat="server" CssClass="btn btn-primary" ForeColor="White" NavigateUrl='<%# "~/subjectexam.aspx?sid=" +  Eval("subject_id") %>'>Sınavlar</asp:HyperLink>
                        </div>
                    </div>
                </div>
            </ItemTemplate>
